    ...
    return (
        <Box position="sticky" bgColor="white" ml={["20px", "35px", "50px"]} width="400px" height="450px" border="1px solid #DBDDE0" p="20px" pt="10px" mt="50px" >
            ...
            <Grid gap="20px" fontSize="18px">
                ...
                {coupon &&
                    <Flex mt="-20px">
                        <input className='couponInput' type="text" placeholder='Type Coupon Code' />
                        <button className='applyCode' >Apply</button>
                    </Flex>
                }
                <Flex>
                ...
                <Flex>
                    ...
                    <Spacer />
                    <Text> ₹{new Intl.NumberFormat().format(count * 30 - 1)} </Text>
                </Flex>
                <Flex fontSize="20px" fontWeight="bold" borderTop="1px solid #DBDDE0" borderBottom="1px solid #DBDDE0" pt="10px" pb="10px" >
                    ...
                    <Spacer />
                    <Text>₹ {Intl.NumberFormat().format(totalprice + count * 30 - 1)}</Text>
                </Flex>
                <Text color="#388E3C" >You will save ₹0 on this order </Text>
